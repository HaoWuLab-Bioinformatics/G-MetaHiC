...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print("X2的shape", X2.shape)
        # print("Z1的shape", Z1.shape)
        # print("X1_rev的shape", X1_rev.shape)
        # print("X2_rev的shape", X2_rev.shape)
        # print("Z1_rev的shape", Z1_rev.shape)
...
class test_Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        y = get_y_vstripe_eval(start, hic, self.input_size)
        y = torch.tensor(y)
